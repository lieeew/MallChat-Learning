package com.leikooo.mallchat.common.mybatis;
...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/lieeew\">leikooo</a>");
        ...
        packageConfig.setParent("com.leikooo.mallchat.common.mapperGenerate");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setPassword("hsphsp");
